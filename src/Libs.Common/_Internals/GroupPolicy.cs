...
namespace Libs.Common._Internals
{
    ...
    internal abstract class GroupPolicyObject
    {
    ...
    internal class GroupPolicyObjectSettings
    {
    ...
    internal class ComputerGroupPolicyObject : GroupPolicyObject
    {
        ...
        public static object GetPolicySetting(string registryInformation, object defaultValue)
        {
            string valueName;
            GroupPolicySection section;
            string key = Key(registryInformation, out valueName, out section);
            ...
            var t = new Thread(() =>
            {
                ...
                using (RegistryKey rootRegistryKey = gpo.GetRootRegistryKey(section))
                {
                    ...
                    using (RegistryKey subKey = rootRegistryKey.OpenSubKey(key, true))
                    {
                        ...
                        {
                            result = subKey.GetValue(valueName, defaultValue);
                        }
                    }
                }
            });
